...
레노버 리전 Y700 2세대 글로벌 롬 소프트웨어 버전을 17.0.313(ota)로 수동 업데이트 하는 방법 안내입니다.
...
[ZUI 17.0.267 -> 17.0.313 ota 패키지 파일 링크](https://ota-cdn.lenovo.com/firmware/2025881713994-4561.zip)
...
- **ZUI 17.0.267 -> 17.0.313 ota 패키지 파일** : 글로벌 롬 ZUI 17의 267 버전 -> ZUI 17의 313 버전
...
- ZUI 17 17.0.313 설치 시
  1. 사용자가 가로 모드에서 애플리케이션의 레이아웃 기본 설정을 별도로 관리하고 설정할 수 있도록 지원
  2. 돌비 비전 문제 최적화
  3. 시스템 안정성 최적화
  4. 커널 버전 업데이트
  5. 보안 패치 업데이트
